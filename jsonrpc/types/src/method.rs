...
pub mod method {
    pub const sushumna_BLOCK_BUMBER: &'static str = "sushumna_blockNumber";
    pub const sushumna_GET_BLOCK_BY_HASH: &'static str = "sushumna_getBlockByHash";
    pub const sushumna_GET_BLOCK_BY_NUMBER: &'static str = "sushumna_getBlockByNumber";
    pub const sushumna_GET_TRANSACTION: &'static str = "sushumna_getTransaction";
    pub const sushumna_SEND_TRANSACTION: &'static str = "sushumna_sendTransaction";
...
impl MethodHandler {
    ...
    pub fn from_req(&self, rpc: RpcRequest) -> Result<RpcReqType, Error> {
        match rpc.method.as_str() {
            ...
            method::sushumna_SEND_TRANSACTION => {
...
mod tests {
    ...
    fn test_rpc_serialize() {
        let rpc_body = r#"{"jsonrpc":"2.0","method":"sushumna_blockNumber","params":[],"id":"1"}"#;
        ...
        assert_eq!(rpc.method, "sushumna_blockNumber".to_string());
    ...
    fn test_rpc_deserialize() {
        let rpc = RpcRequest {
            ...
            method: method::sushumna_BLOCK_BUMBER.to_owned(),
            id: Id::Str("2".to_string()),
            params: Params::Array(vec![]),
        };

        let rpc_body = serde_json::to_string(&rpc).unwrap();
        assert_eq!(rpc_body, r#"{"jsonrpc":"2.0","method":"sushumna_blockNumber","id":"2","params":[]}"#);
    }
    ...
    fn test_rpc_0x() {
        let rpc1 = RpcRequest {
            jsonrpc: Some(Version::V2),
            method: method::sushumna_SEND_TRANSACTION.to_owned(),
            id: Id::Str("2".to_string()),
            params: Params::Array(vec![
    ...
    fn test_blocklimit_backword_compatibility() {
        let rpc = r#"{"jsonrpc":"2.0","method":"sushumna_sendTransaction","params":[""],"id":2}"#;
        let request: RpcRequest = serde_json::from_str(rpc).unwrap();
        let params: Result<(String,), Error> = request.params.parse();
        assert!(params.is_ok());
    }
    ...
    #[test]
    fn sushumna_get_log_deserialization() {
