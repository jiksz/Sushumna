...
::
    ...
    // Request
    curl -X POST --data '{"jsonrpc":"2.0","method":"sushumna_getBlockByHash","params":["2f3853b7d3bb3d6bc4bb2103b645aae2b8145125340018209184c7709e04dbc3", true],"id":1}' 127.0.0.1:1337 | jq
...
::
    ...
    // Request
    curl -X POST --data '{"jsonrpc":"2.0","method":"sushumna_getBlockByNumber","params":["0xF9", true],"id":1}' 127.0.0.1:1337 | jq
    或者
    curl -X POST --data '{"jsonrpc":"2.0","method":"sushumna_getBlockByNumber","params":["249", true],"id":1}' 127.0.0.1:1337 | jq
    或者
    curl -X POST --data '{"jsonrpc":"2.0","method":"sushumna_getBlockByNumber","params":[249, true],"id":1}' 127.0.0.1:1337 | jq
...
::
    ...
    // 应发送POST请求，而不是GET请求
    curl -X GET -d '{"jsonrpc":"2.0","method":"sushumna_blockNumber","params":[]}' 127.0.0.1:1337 | jq
    ...
    // hash值没有前缀0x
    curl -X POST -d '{"jsonrpc":"2.0","method":"sushumna_getTransaction","params":["0x0063187e6a84ae731cf9"],"id":2}' 127.0.0.1:1337 | jq
    ...
    // 高度未达到
    curl -X POST -d '{"jsonrpc":"2.0","method":"sushumna_getBlockByNumber","params":[99999,true],"id":2}' 127.0.0.1:1337 | jq
