...
#![allow(dead_code)]
use sushumna_ed25519::{Signature as ED_Signature, recover as ed_recover};
use sushumna_secp256k1::{Signature, recover as ec_recover};
...
mod tests {
    ...
    use sushumna_ed25519::{KeyPair, sign as ED_sign, pubkey_to_address as ED_pubkey_to_address};
