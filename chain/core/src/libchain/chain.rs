...
impl Chain {
    ...
    pub fn sushumna_call(&self, request: CallRequest, id: BlockId) -> Result<Bytes, String> {
...
#[cfg(test)]
mod tests {
    extern crate sushumna_ed25519;
    extern crate env_logger;
    extern crate mktemp;
    extern crate test;
    use self::Chain;
    use super::*;
    use sushumna_ed25519::KeyPair;
    use db;
    ...
    fn create_block(chain: &Chain, privkey: &sushumna_ed25519::PrivKey, to: Address, data: Vec<u8>, nonce: (u32, u32)) -> Block {
    ...
    #[test]
    fn test_code_at() {
        let keypair = sushumna_ed25519::KeyPair::gen_keypair();
        let privkey = keypair.privkey();
        let chain = init_chain();
        /*
    ...
    fn test_contract() {
        ...
        let privkey = sushumna_ed25519::PrivKey::from("fc8937b92a38faf0196bdac328723c52da0e810f78d257c9ca8c0e304d6a3ad5bf700d906baec07f766b6492bea4223ed2bcbcfd978661983b8af4bc115d2d66");
        let pubkey = sushumna_ed25519::PubKey::from("bf700d906baec07f766b6492bea4223ed2bcbcfd978661983b8af4bc115d2d66");
		...
		*/
        ...
        let call_result = chain.sushumna_call(call_request, BlockId::Latest);
