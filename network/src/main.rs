...
extern crate util;
extern crate dotenv;
extern crate sushumna_log;
extern crate bytes;

pub mod config;
pub mod server;
pub mod connection;
pub mod sushumnaprotocol;
pub mod msghandle;
...
fn main() {
    ...
    // Init logger
    sushumna_log::format(LogLevelFilter::Info);
    info!("sushumna:network");
    // init app
    // todo load config
    let matches = App::new("network")
        .version("0.1")
        .author("Cryptape")
        .about("sushumna Block Chain Node powered by Rust")
